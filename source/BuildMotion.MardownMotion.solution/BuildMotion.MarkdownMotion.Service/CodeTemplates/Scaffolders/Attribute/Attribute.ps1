...
Add-ProjectItemViaTemplate $outputPath$fileName `
	...
	-Model @{ Namespace = "$namespace.Business.$AttributeSectionName.Attributes"; Name = $AttributeName; BaseNamespace = $baseNamespace; UsingNamespace = "$namespace.Business.$AttributeSectionName.Rules"} `
