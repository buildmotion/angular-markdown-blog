...
$actionPath = "BuildMotion\Actions"
...
Add-ProjectItemViaTemplate $outputPath$fileName `
	...
	-Model @{ Namespace = "$namespace.BuildMotion.Actions"; ClassName=$fileName; BaseNamespace = $namespace; UseProviderRepository = $UseProviderRepository; BaseName = $ActionBaseName } `
